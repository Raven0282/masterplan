...
namespace Masterplan.Tools
{
    ...
    public class RtfExporter
    {
        ...
        private Dictionary<string, int> CssToRtfColorIndex = new Dictionary<string, int>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            // The duplicate entry {"#000000", 0} was removed here to resolve the exception.
            {"#FFFFFF", 1},
        };
        ...
        public string ExportToRtf(string htmlContent)
        {
            ...
            // Removed \qc (center alignment) to default to left alignment in cells.
            ...
            if (rows != null)
            {
                foreach (var rowNode in rows)
                {
                    ...
                    foreach (var cellNode in cells)
                    {
                        ...
                        cumulativeWidthTwips += cellWidth;
                        ...
                        // Start with left alignment for cell content
                        string textFormatStart = "\\ql ";
        ...
        private string StripAndProcessHtml(string html)
        {
            ...
            cleanText = Regex.Replace(cleanText, "<br\\s*/?>", "\\line ", RegexOptions.IgnoreCase | RegexOptions.Multiline);
