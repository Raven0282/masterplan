    ...
    partial class MainForm : Form
    {
        ...
        private void Preview_Navigating(object sender, WebBrowserNavigatingEventArgs e)
        {
            try
            {
                ...
                if (e.Url.Scheme == "failure")
                {
                    ...
                    // Failure
                    PlotPoint point = get_selected_point();
                    if (point.Element is SkillChallenge sc)
                    {
                        SkillChallengeData scd = sc.FindSkill(e.Url.LocalPath);
                        scd.Results.Fails += 1;
        ...
        private void NavigationTree_DragOver(object sender, DragEventArgs e)
        {
            try
            {
                ...
                if (e.Data.GetData(typeof(PlotPoint)) is PlotPoint pp)
                {
            ...
            try
            {
                ...
                if (PlotView.SelectedPoint != null)
                {
                    foreach (PlotPoint pp in PlotView.Plot.Points)
                    {
                        ...
                        ToolStripMenuItem tsmi = new("After \"" + pp.Name + "\"");
        ...
        private void ToolsPreferenceEditFormatNarrow_Click(object sender, EventArgs e)
        {
            try
            {
                Session.Preferences.EditSize = EditFormat.Narrow;
                update_preview();
                if (fWelcome != null)
                    fWelcome.RefreshOptions();
        ...
        private void ToolsPreferenceEditFormatFull_Click(Object sender, EventArgs e)
        {
            try
            {
                Session.Preferences.EditSize = EditFormat.Wide;
                update_preview();
                if (fWelcome != null)
                    fWelcome.RefreshOptions();
        ...
        private void HelpManual_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    FileName = path, // Or your file path/URL
                    UseShellExecute = true // *** This is the critical line! ***
                };
